...
WebUI.click(findTestObject('Page_GitHub/button_edit'))

WebUI.setText(findTestObject('Object Repository/Page_Create a new Gist/div_1public class Hello2public'), '\npublic class Hello{\npublic statis void main (String args[]){\nSystem.out.println(“Hello Shopee Edit”)\n}\n}')

WebUI.click(findTestObject('Page_GitHub/push'))
