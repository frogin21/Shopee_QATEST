...
WebUI.click(findTestObject('Page_The worlds leading software de/a_Sign in'))
...
WebUI.setText(findTestObject('Object Repository/Page_Create a new Gist/input_Instantly share code not'), 'Hello.java')

WebUI.click(findTestObject('Object Repository/Page_Create a new Gist/div_1'))

WebUI.setText(findTestObject('Object Repository/Page_Create a new Gist/div_1public class Hello2public'), 'public class Hello{\npublic statis void main (String args[]){\nSystem.out.println(“Hello Shopee”)\n}\n}')
